module FunWithStrings
  ...
  def anagram_groups
    #split the word with words hashed it then made it an array
    Array( self.split.each_with_object(Hash.new{ |hash, key| hash[key] = [] }) { |word, num| num[word.downcase.chars.sort.join] << word }.values )
  end
end
